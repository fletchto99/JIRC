...
public class IniParser {
    ...
    public static HashMap<String, HashMap<String, String>> deserialise(
        ...
        String line, section = IniParser.emptySection;
        ...
        while ((line = input.readLine()) != null) {
            ...
            if (t == IniParser.sectionOpen) {
                z = line.indexOf(IniParser.sectionClose, 1);
                z = z == -1 ? l : z;
                section = z == 1 ? "" : line.substring(1, z).trim();
            } else {
                boolean skip = false;
                for (final char c : IniParser.comments) { // skip on lines that are
                    // comments
                    if (t == c) {
                        skip = true;
                        break;
                ...
                z = line.indexOf(IniParser.keyBound);
                z = z == -1 ? l : z;
                String key, value = "";
    ...
    public static HashMap<String, HashMap<String, String>> deserialise(
        ...
        final BufferedReader reader = new BufferedReader(new InputStreamReader(
                in));
        final HashMap<String, HashMap<String, String>> data = IniParser
                .deserialise(reader);
        reader.close();
        return data;
    }

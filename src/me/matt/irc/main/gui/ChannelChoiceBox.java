...
public class ChannelChoiceBox extends JFrame {
    ...
    private void init() {
        ...
        this.setTitle(Messages.JOINCHANNEL);
        ...
        passCheck.setBounds(new Rectangle(new Point(55, 55), passCheck
                .getPreferredSize()));
        passCheck.addActionListener(arg0 -> {
